    ...
    <div className="flex flex-col h-full min-h-0 gap-4">
      ...
      {annotateSummary && Object.keys(annotateSummary).length > 0 && (
        <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200/60 flex-wrap">
          <span className="text-[11px] text-slate-400 shrink-0">标注汇总：</span>
      ...
      {/* Table */}
      <div ref={tableRef} className="flex-1 min-h-0 max-h-[65vh] overflow-y-auto overflow-x-hidden bg-white data-table-wrap">
        {!hasContent ? (
