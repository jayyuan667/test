...
const NAV_ITEMS: { id: PageId; icon: string; title: string; sub: string }[] = [
  { id: 'zip',       icon: '⧉', title: '工艺入库', sub: '批次报告与记录浏览' },
  { id: 'generate',  icon: '⬚', title: '工艺生成', sub: '模型预览与工艺编制' },
  { id: 'history',   icon: '☷', title: '历史记录', sub: '历史输出与特征回看' },
  { id: 'db',        icon: '⛁', title: '数据库浏览', sub: '客户可见、支持修改删除' },
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/[0.06]">
          ...
          <div className="overflow-hidden" style={{ opacity: collapsed ? 0 : 1, transition: 'opacity 0.2s ease' }}>
            ...
            <div className="text-[11px] text-white/40 mt-0.5 font-medium tracking-wider uppercase">Process Intelligence</div>
          </div>
        </div>
