      ...
      <div ref={heroRef} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="card-solid relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-[12px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">知识库构建</div>
        ...
        <div className="card-solid flex flex-col gap-3 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-3">
              <label className="text-[12px] font-semibold text-slate-500 mb-1.5 block">选择目标库</label>
              <select
      ...
      <div ref={workspaceRef} className="card-solid flex flex-col gap-4">
        ...
        {statusZone === 'idle' && (
          ...
          >
            ...
            <div className="text-[12px] text-slate-400 max-w-[42ch]">
        ...
        {report && (
          <div ref={resultRef} className="flex flex-col gap-3">
              ...
              <div>
                {matchedPairs.length === 0 ? (
                  ...
                  <>
                    {/* Pager */}
                    <div className="flex items-center justify-between mb-3">
                      <div className="text-[12px] text-slate-400">当前页：第 {matchedPage} / {matchedTotalPages} 页</div>
            ...
            {resultTab === 'unmatched' && (
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="text-[12px] text-slate-400">当前页：第 {unmatchedPage} / {unmatchedTotalPages} 页</div>
                  <div className="flex gap-2">
