...
ZIP_IMPORT_MAX_WORKERS = int(os.getenv("ZIP_IMPORT_MAX_WORKERS", os.getenv("ZIP_IMPORT_BACKGROUND_WORKERS", "1")))
...
def import_zip_async_route():
    ...
    workflow_run_id = context["workflow_run_id"]
    active_run = find_running_workflow(
        "zip_import",
