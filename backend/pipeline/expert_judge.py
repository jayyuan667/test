...
- 只输出 JSON，不输出任何 Markdown 标记或其他文字

材料提取注意事项：
- 材料可能出现在【材料】字段，也可能在【其他特征】中（如"零件材料为2A12铝合金"）或【技术要求】中
- 如果【图号】字段的值看起来是材料牌号（如 AL2A12、2A12、6061、45钢、铝合金代码），应将其识别为材料填入 material，图号填'未知'
- 常见铝合金代码：2A12、6061、6063、7075、AL2A12、AL6061 等；常见钢材代码：45、40Cr、Q235 等
- 如描述中确实没有材料信息，material 填'未知'是正确答案，不要猜测""".strip()
