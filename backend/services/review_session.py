...
def persist_review_payload(task: dict) -> None:
    ...
    payload = {
        ...
        "original_png_paths": task.get("original_png_paths", []),
        "preview_image_urls": task.get("preview_image_urls", []),
        ...
        "retrieval_library_key": task.get("retrieval_library_key") or "",
        "retrieval_library_resolution": task.get("retrieval_library_resolution") or {},
...
def restore_task_from_pending(task_id: str, tasks: dict, event_data: dict, event_locks: dict) -> dict | None:
    ...
    restored = {
        ...
        "original_png_paths": pending.get("original_png_paths", []),
        "preview_image_urls": pending.get("preview_image_urls", []),
        ...
        "library_key": pending.get("library_key") or "public",
        "retrieval_library_key": pending.get("retrieval_library_key") or "",
        "retrieval_library_resolution": pending.get("retrieval_library_resolution") or {},
        "enterprise_id": pending.get("enterprise_id"),
...
def restore_task_from_result(task_id: str, tasks: dict, event_data: dict, event_locks: dict) -> dict | None:
    ...
    restored = {
        ...
        "retrieval_library_key": result.get("retrieval_library_key") or "",
        "retrieval_library_resolution": result.get("retrieval_library_resolution") or {},
