...
def emit_step_start(
    ...
    try:
        from ..task_store import save_event
        save_event(task_id, "step_start", data)
    except Exception:
        pass
...
def emit_step_complete(
    ...
    try:
        from ..task_store import save_event
        save_event(task_id, "step_complete", data)
    except Exception:
        pass
...
def emit_complete(
    ...
    try:
        from ..task_store import save_event
        save_event(task_id, "complete", data)
    except Exception:
        pass
...
def emit_image_ready(
    ...
    try:
        from ..task_store import save_event
        save_event(task_id, "image_ready", data)
    except Exception:
        pass
