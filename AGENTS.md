...
This project is indexed by GitNexus as **test** (7892 symbols, 12870 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
