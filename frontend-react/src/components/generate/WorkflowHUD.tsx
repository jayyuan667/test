...
export function WorkflowHUD({ progress, phaseHint, busy, completed, waiting }: Props) {
  ...
  }, [params, busy, completed, waiting, reduceMotion])
  ...
  }, [params, busy, waiting, reduceMotion])
